"""
Module containing raport part of bee algorithm solver
"""

import hashlib

from bee_alg.rating import create_fenotype


class BeeAlgorithmReport(object):
    """
    Class descripting bee algorithm solution and details.
    """
